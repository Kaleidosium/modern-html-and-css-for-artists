  ...
  var e = (() => {
    ...
    return (e) => {
      const _ = e.regex,
        ...
        t = e.COMMENT(/\/\*/, /\*\//, {
          relevance: 0,
          contains: [{ scope: "doctag", match: /@(return|param)/ }],
        }),
        r = {
          scope: "meta",
          begin: /#include\b/,
      ...
      return {
        ...
        contains: [
          ...
          {
            match: _.concat(/[<,]\s*/, _.either(...i), /\s*=/),
            keywords: i,
          },
          { scope: "keyword", match: /\btarget(?=\s*\+=)/ },
          {
            match: [/~\s*/, _.either(...o), /(?:\(\))/, /\s*T(?=\s*\[)/],
