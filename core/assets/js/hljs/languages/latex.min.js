  ...
  var e = (() => {
    ...
    return (e) => {
      const n = [
        ...
        i = { begin: /\{/, end: /\}/, relevance: 0, contains: ["self", ...a] },
        t = e.inherit(i, { relevance: 0, endsParent: !0, contains: [i, ...a] }),
        r = {
          begin: /\[/,
          end: /\]/,
          endsParent: !0,
      ...
      return {
        ...
        contains: [
          ...
          ...[].concat(
            ...["", "\\*"].map((e) => [
              g("verbatim" + e, b("verbatim" + e)),
              g("filecontents" + e, o(c, b("filecontents" + e))),
              ...["", "B", "L"].map((n) =>
                g(n + "Verbatim" + e, o(l, b(n + "Verbatim" + e))),
              ),
            ]),
          ),
          g("minted", o(l, o(c, b("minted")))),
          ...a,
        ],
      };
    };
