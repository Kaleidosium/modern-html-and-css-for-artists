    ...
    return (e) => {
      const t = "[^\\(\\)\\[\\]\\{\\}\",'`;#|\\\\\\s]+",
        ...
        u = {
          ...
          contains: [
            { begin: "\\(", end: "\\)", contains: ["self", a, c, i, l, o] },
          ],
        },
        d = { className: "name", relevance: 0, begin: t, keywords: r },
        p = {
          variants: [
            { begin: "\\(", end: "\\)" },
            { begin: "\\[", end: "\\]" },
      ...
      return (
        (g.contains = [a, i, c, l, o, u, p].concat(s)),
        {
          name: "Scheme",
          aliases: ["scm"],
          illegal: /\S/,
