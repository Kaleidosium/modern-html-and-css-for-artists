...
(() => {
  var e = (() => {
    ...
    function a(...n) {
      ...
      return "(" + (t.capture ? "" : "?:") + n.map((n) => e(n)).join("|") + ")";
    }
    ...
    return (e) => {
      const d = { match: /\s+/, relevance: 0 },
        ...
        E = [e.C_LINE_COMMENT_MODE, h],
        A = { match: [/\./, a(...s, ...c)], className: { 2: "keyword" } },
        C = { match: t(/\./, a(...o)), relevance: 0 },
        k = o.filter((e) => "string" == typeof e).concat(["_|0"]),
        N = {
          variants: [
            {
              className: "keyword",
        ...
        D = [
          ...
          { className: "built_in", match: t(/\b/, a(...p), /(?=\()/) },
        ],
        _ = { match: /->/, relevance: 0 },
        M = [
          _,
        ...
        G = [
          {
            ...
            starts: {
              contains: [
                { begin: /\(/, end: /\)/, keywords: v, contains: [...M, $, T] },
              ],
            },
          },
          {
        ...
        H = {
          ...
          contains: [
            ...
            { className: "type", match: g, relevance: 0 },
            { match: /[?!]+/, relevance: 0 },
            {
              match: /\.\.\./,
              relevance: 0,
            },
            { match: t(/\s+&\s+/, n(g)), relevance: 0 },
          ],
        },
        R = {
          begin: /</,
      ...
      const X = {
        ...
        Y = {
          match: [/(func|macro)/, /\s+/, a(W.match, w, b)],
        ...
        ae = {
          ...
          contains: [
            ...
            ...B,
            {
              ...
              keywords: S,
              contains: [{ scope: "title.class.inherited", match: g }, ...B],
              relevance: 0,
            },
          ],
        };
      ...
      return {
        ...
        contains: [
          ...
          ne,
          te,
          { beginKeywords: "import", end: /$/, contains: [...E], relevance: 0 },
          V,
          ...B,
          ...D,
          ...M,
