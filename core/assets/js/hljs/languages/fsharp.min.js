...
(() => {
    ...
    return (n) => {
      const r = {
        ...
        y = {
          ...
          contains: [
            c,
            n.inherit(l, { scope: null }),
            p,
            { scope: "operator", match: /<|>/ },
            m,
          ],
        },
        E = { scope: "computation-expression", match: /\b[_a-z]\w*(?=\s*\{)/ },
        _ = {
          begin: [
            /^\s*/,
            i(
        ...
        A = {
          ...
          contains: [{ match: /""/ }, n.BACKSLASH_ESCAPE],
        },
        S = { scope: "string", begin: /"""/, end: /"""/, relevance: 2 },
        C = { scope: "subst", begin: /\{/, end: /\}/, keywords: s },
        O = {
          scope: "string",
          begin: /\$"/,
          end: /"/,
      ...
      return (
        (C.contains = [R, O, A, w, x, r, c, l, m, E, _, v, p, d]),
        {
          name: "F#",
          aliases: ["fs", "f#"],
          keywords: s,
  ...
  hljs.registerLanguage("fsharp", e);
})();
