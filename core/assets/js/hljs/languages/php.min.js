    ...
    return (e) => {
      const t = e.regex,
        ...
        f = {
          ...
          keywords: E,
          contains: [I, o, m, e.C_BLOCK_COMMENT_MODE, l, d, g],
        },
        O = {
          relevance: 0,
          match: [
      ...
      f.contains.push(O);
      const v = [I, m, e.C_BLOCK_COMMENT_MODE, l, d, g];
      return {
        case_insensitive: !1,
        keywords: E,
        contains: [
          {
            ...
            endScope: "meta",
            keywords: { literal: _, keyword: ["new", "array"] },
            contains: [
              {
                begin: /\[/,
                end: /]/,
          ...
          g,
          {
            ...
            contains: [
              ...
              { begin: "=>", endsParent: !0 },
              {
                ...
                excludeEnd: !0,
                keywords: E,
                contains: ["self", o, m, e.C_BLOCK_COMMENT_MODE, l, d],
              },
            ],
          },
          {
