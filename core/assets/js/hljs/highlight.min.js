      ...
      ((e) => {
        if (Array.isArray(e.end)) {
          if (e.skip || e.excludeEnd || e.returnEnd)
            throw (
              W("skip, excludeEnd, returnEnd not compatible with endScope: {}"),
              K
            );
  ...
  function V(e) {
    ...
    class n {
      ...
      compile() {
        ...
        ((this.matcherRe = t(m(e, { joinWith: "|" }), !0)),
          (this.lastIndex = 0));
      }
      exec(e) {
          ...
          (null != N.subLanguage
            ? (() => {
                ...
                if ("string" == typeof N.subLanguage) {
                  ...
                  ((e = E(N.subLanguage, R, !0, S[N.subLanguage])),
                    (S[N.subLanguage] = e._top));
                } else e = x(R, N.subLanguage.length ? N.subLanguage : null);
                (N.relevance > 0 && (j += e.relevance),
        ...
        try {
          if (_.__emitTokens) _.__emitTokens(n, M);
            ...
            for (N.matcher.considerAll(); ;) {
              (I++,
                T ? (T = !1) : N.matcher.considerAll(),
                (N.matcher.lastIndex = A));
